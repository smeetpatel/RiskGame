...
/**
 * Interface to read/write conquest map format.
 */
public interface ConquestMap {
    /**
     ...
     * @throws IOException
     */
    BufferedReader readContinents(BufferedReader reader, GameMap map);
     ...
     * @throws IOException
     */
    BufferedReader readTerritories(BufferedReader reader, GameMap map);
