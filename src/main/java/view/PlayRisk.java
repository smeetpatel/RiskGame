            ...
            if (command.equals("1")) {
                ...
                while (!validCommand) {
                    ...
                    if (command.equals("1")) {
                        ...
                        //allow players to place all the initial armies
                        ...
                        while (controller.getGame().getGamePhase() != Phase.CARDEXCHANGE) {
                            ...
                            if (!player.getIsBot()) {
                                ...
                                //TODO: execute following code when player is not human
                                command = "placeall";
                            }
                        ...
                        while (controller.getGame().getGamePhase() != Phase.QUIT) {
                            ...
                            if (!player.getIsBot()) {
                            	...
                            	// TODO: Execute code when player is not human.
								Command command1 = new Command();
								command1.botCommand(player);
							}
                        }
                    } else {
